...
const LastScan = () => {
    return (
        <main className="w-full h-1/3 flex items-center justify-center p-10 xl:h-full xl:w-screen xl:p-2">
            <div className="w-full h-full bg-white/20 backdrop-blur  off:bg-lastScanColor/90 duration-500 shadow-xl rounded-xl flex flex-col items-center justify-evenly">
                <div className="text-2xl 2xl:text-lg font-semibold text-center w-56 xl:w-full text-white">
