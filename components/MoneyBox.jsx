...
const MoneyCounter = () => {
    ...
    return (
        <main className="w-full h-1/2 flex items-center justify-center pl-8 pr-2 pt-0 pb-20 xl:w-full xl:p-2 xl:h-full">
            <div className="w-full h-full off:bg-black/80 bg-moneyCounterColor/90 duration-300 rounded-xl flex flex-col items-center justify-evenly xl:p-2 off:shadow-xl">
